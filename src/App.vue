<template>
  <section id="app-container">
    ...
    <transition name="fade">
      <modal v-show="isModal" @closemodal="closeModal()" :mode="modalinfo.mode" :title="modalinfo.title"" :content="
        modalinfo.content" :width="modalinfo.width" :ok="modalinfo.ok"" :cancel=" modalinfo.cancel"></modal>
    </transition>
  </section>
</template>
<script>
...
<style lang="less">
  ...
  .transiton-reverse .slide-enter,
  .transiton-reverse .slide-leave-active {
    transform: translate3d(110%, 0, 0);
  }
